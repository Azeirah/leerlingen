...
var LeerlingenContainer = React.createClass({displayName: 'LeerlingenContainer',
    getInitialState: function () {
        var leerlingen = util.collectObservable(this.props.leerlingStream);
        return {leerlingen: leerlingen};
    },
    componentWillMount: function () {
        var that = this;
        var nieuweLeerlingen = this.props.leerlingen.map(function (i) {return i;});
        this.setState(nieuweLeerlingen);
        log(that.state);
        log(nieuweLeerlingen);
    },
    render: function () {
