...
var LeerlingenContainer = React.createClass({displayName: 'LeerlingenContainer',
    ...
    componentWillMount: function () {
        var that = this;
        console.log(this.props.leerlingen.map(function (leerling) {return leerling;}));
        this.props.leerlingen.map(function (leerling) {return leerling;}).onValue(function (value) {
            console.log(value);
            that.setState({leerlingen: leerlingen});
        });
    },
