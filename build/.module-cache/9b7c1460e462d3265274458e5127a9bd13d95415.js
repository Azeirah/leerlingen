...
var Statistiek = React.createClass({displayName: 'Statistiek',
    render: function () {
        ...
        return (
            React.createElement("p", null, "In totaal zijn er ", React.createElement("span", {class: "nummer"}, aantalLeerlingen), " leerlingen")
        );
    }
});
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "LeerlingenContainer"}, 
                leerlingenLijst, 
                React.createElement(NiewLeerlingForm, null)
            )
        );
    }
});
...
var NiewLeerlingForm = React.createClass({displayName: 'NiewLeerlingForm',
    render: function () {
        return (
